    ...
    <div className="relative h-screen flex-grow overflow-y-scroll scrollbar-hide">
      <header className="absolute top-5 right-8">
        <div className="relative inline-block ">
          ...
          <div
            className={`relative right-0 z-20 mt-2 w-full max-w-full rounded-md bg-white py-2 shadow-xl dark:bg-gray-800 ${
              open ? 'block' : 'hidden'
            }`}
          >
            <Link href={'/dashboard'}>
              <button className="flex transform items-center px-3 py-3 text-sm capitalize text-gray-600 transition-colors duration-200 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white">
                <svg
            ...
            <a
              href="#"
              className="flex transform items-center p-3 text-sm capitalize text-gray-600 transition-colors duration-200 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white"
            >
              <svg
                className="mx-1 h-5 w-5"
                viewBox="0 0 24 24"
