  ...
  return (
    <div className="flex h-screen w-64 flex-col border-r bg-white px-4 py-8 dark:border-gray-600 dark:bg-gray-800">
      ...
      <div className="mt-6 flex flex-1 flex-col justify-between">
        <nav>
          <a
            className="flex items-center rounded-md bg-gray-200 px-4 py-2 text-gray-700 dark:bg-gray-700 dark:text-gray-200"
            href="#"
          >
            <svg
              className="h-5 w-5"
            ...
            <span className="mx-4 font-medium">Song</span>
          </a>
